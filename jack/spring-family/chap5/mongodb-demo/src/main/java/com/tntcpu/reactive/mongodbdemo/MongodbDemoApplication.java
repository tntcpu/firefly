package com.tntcpu.reactive.mongodbdemo;

import com.tntcpu.reactive.mongodbdemo.converter.MoneyReadConverter;
import com.tntcpu.reactive.mongodbdemo.converter.MoneyWriterConverter;
import com.tntcpu.reactive.mongodbdemo.model.Coffee;
...
public class MongodbDemoApplication implements ApplicationRunner {
    ...
    public MongoCustomConversions mongoCustomConversions() {
        return new MongoCustomConversions(
                Arrays.asList(new MoneyReadConverter(), new MoneyWriterConverter())
        );
    }
