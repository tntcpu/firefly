...
abstract class Event implements Runnable, Delayed {
	...
	public Event(long delayTime) { this.delayTime = delayTime;}
...
class GreenhouseControls extends Controller{
	public GreenhouseControls(DelayQueue<Event> q) { super(q); }
	...
	public class LightOn extends Event{
		...
		public String toString(){return "light is no";}
	}
	public class LightOff extends Event{
		public LightOff(long delayTime) { super(delayTime); }
		public void run() { light = false; }
...
public class E33_GreenhouseController {
	public static void main(String[] args) {
		...
		gc.addEvent(
					new GreenhouseControls.Terminate(5000, exec));
		exec.execute(gc);
	}
}
